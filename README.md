...
![Tests](https://img.shields.io/badge/Tests-408%2F408%20passing-brightgreen)
...
| `.npmrc` hardening | [`.npmrc`](.npmrc) + [guide](docs/en/npmrc-hardening.md) | Hardened npm defaults for pinning, scripts, audit, TLS, and telemetry |
